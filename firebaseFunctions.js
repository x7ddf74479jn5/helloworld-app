...
var config = require("./src/next.config");
var nextjsDistDir = (0, path_1.join)('src', config.distDir);
...
var fn = functions.region('us-central1');
exports.nextjsFunc = fn.https.onRequest(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
